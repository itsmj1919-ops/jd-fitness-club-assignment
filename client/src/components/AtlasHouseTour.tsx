...
const tourCaptionCues = [
  { start: 0, end: 1.5, text: "[Soft architectural room tone]\nPERFORMANCE ATLAS — HOUSE TOUR" },
  { start: 1.5, end: 3.2, text: "ENTER THE ATLAS HOUSE" },
